...
void brick_11_after(uint8_t x, uint8_t y);  /* 1ac2:4c4b */
...
void cell_hole_draw(uint8_t x, uint8_t y);  /* 1ac2:4cc1 */
...
void read_new_key(uint16_t which);  /* 1ac2:1614 */
...
void draw_anim_cell(const anim_sprite_t *sprite, uint8_t x, uint8_t y); /* 1ac2:3bac */
...
void xor_sprite_16x7(uint8_t x, uint8_t y, const uint8_t *src); /* 1ac2:3b64 */
...
void xor_sprite_20x16(uint8_t x, uint8_t y, const uint8_t *src); /* 1ac2:406a */
void sprite_shift_draw(uint8_t x, uint8_t y, const uint8_t *src); /* 1ac2:3f4f */
