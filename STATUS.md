...
| | routines | |
| --- | ---: | --- |
| **transcribed** | | 181 of 181 routines the port is meant to have, 24916 of 24916 bytes (100.0%) |
| **proven** | 163 | reached, did work, agreed on every route that reached it |
| shallow | 1 | agreed, but every call was an early return - not proof |
| differing | 1 | entity_paddle_fx |
| unreached | 1 | no route runs them |
| **dispatched** | 166 | what verify.c can check |

Routes in this union: play, menu, keyboard, menu.snap +@0206:f8, menu.snap +@0206:f10, menu.snap +@0206:f6, menu.snap +@0206:f2, menu.snap +@0206:^l,@0206:^a,@0206:^c,@0206:^r,@0206:^a,@0206:^l,@0206:space,@0206:s,@0206:o,@0206:f,@0206:t,@0206:w,@0206:a,@0206:r,@0206:e,@0206:return, menu.snap +@0206:f2,@1785:p,@1785:o,@1785:p, level10_f000000.snap +@1a62:escape,@1a62:space, cap.snap, level10_f000000.snap, level49_f000000.snap, particles.snap, tall.snap, marks.snap, vlife.snap, ending.snap, twoplayer2.snap, tablehole2.snap, holes.snap, play (chase), menu (chase), keyboard (chase), menu.snap +@0206:f8 (chase), menu.snap +@0206:f10 (chase), menu.snap +@0206:f6 (chase), menu.snap +@0206:f2 (chase), menu.snap +@0206:^l,@0206:^a,@0206:^c,@0206:^r,@0206:^a,@0206:^l,@0206:space,@0206:s,@0206:o,@0206:f,@0206:t,@0206:w,@0206:a,@0206:r,@0206:e,@0206:return (chase), menu.snap +@0206:f2,@1785:p,@1785:o,@1785:p (chase), level10_f000000.snap +@1a62:escape,@1a62:space (chase), cap.snap (chase), level10_f000000.snap (chase), level49_f000000.snap (chase), particles.snap (chase), tall.snap (chase), marks.snap (chase), vlife.snap (chase), ending.snap (chase), twoplayer2.snap (chase), tablehole2.snap (chase), holes.snap (chase).

**Three routines are not in the 163, and each has a reason:**

- `set_palette_registers` (`0x4b7a`) writes twelve values to ports 0x3d0-0x3db
  and touches no memory at all - it is an EGA palette write on what is meant
  to be a CGA, and does nothing on either. So it agrees on every call and can
  never "do work", and it will sit in the shallow column for ever. It stays
  dispatched because "no memory side effects" is worth confirming even when it
  is the whole of what there is to confirm.
