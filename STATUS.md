...
rather than remembered, and re-running it is how it should be updated.

<!-- generated by verify_all.py --summary -->
| | routines | |
| --- | ---: | --- |
| **transcribed** | | 185 of 185 reachable routines transcribed, 25230 of 25230 bytes (100.0%) |
| **proven** | 125 | reached, did work, agreed on every route that reached it |
| shallow | 4 | agreed, but every call was an early return - not proof |
| differing | 2 | bonus_end_level, entity_paddle_fx |
| unreached | 29 | no route runs them |
| **dispatched** | 159 | what verify.c can check |

Routes in this union: play, menu, keyboard, menu.snap +@0206:f8, menu.snap +@0206:f10, menu.snap +@0206:f6, menu.snap +@0206:f2, cap.snap, level06_f153048.snap, level10_f000000.snap, level49_f000000.snap, particles.snap, tall.snap, ending.snap.
...
before. Proven went from 82 to 125 in one session purely by reaching further,
